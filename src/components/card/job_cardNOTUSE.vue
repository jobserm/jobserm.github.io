...
<div>
    ...
    <div class="paginate">
        <ve-pagination :page-index="pageIndex" :total="count_job" :page-size="4" :layout="['total', 'prev', 'pager', 'next', 'jumper']" @on-page-number-change="pageNumberChange"></ve-pagination>
    </div>
</div>
</template>
